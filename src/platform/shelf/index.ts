...
export { donoDaVitrine, marcarDonoDaVitrine } from "./shelf.identity";
export { lerCookieDaVitrine, serializarCookieDaVitrine, SHELF_COOKIE } from "./shelf.cookie";
export { vitrineDoComprador } from "./shelf.actions";
export type { ItemRenderizavel, VitrinePersonalizada } from "./shelf.actions";
