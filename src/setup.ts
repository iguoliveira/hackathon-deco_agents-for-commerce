...
registerCommerceLoaders({
  ...
  "site/loaders/personalShelf.ts": async () => (await import("./loaders/personalShelf")).default(),
  "site/loaders/personalShelf": async () => (await import("./loaders/personalShelf")).default(),
});
