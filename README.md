...
| **shelf** | `src/platform/shelf/` | A vitrine do "avise-me": substitutos e complementos ancorados no item esgotado. |
...
Sem estas, o site sobe e funciona; os agentes é que não compõem.
...
### 3. Dependências — **bun obrigatório**
...
| `npm run shelf:dryrun -- <email>` | a vitrine do "avise-me" | chama o modelo |
...
**O provedor do modelo cai.** Falha entra em quarentena de 10 minutos por peça,
para que "o provedor está fora" não vire mais carga. A section reaparece sozinha
quando ele volta.
